...
export class ReportsPage implements OnInit {
  ...
  defensive_1:any;
  ofensive_1:any;
  trans_defensive_1:any;
  trans_ofensive_1:any;
  strengths_1:any;
  weakness_1:any;
  other_1:any;
  prim_game_system_1:any;
  sec_game_system_1:any;

  defensive_2:any;
  ofensive_2:any;
  trans_defensive_2:any;
  trans_ofensive_2:any;
  strengths_2:any;
  weakness_2:any;
  other_2:any;
  prim_game_system_2:any;
  sec_game_system_2:any;

  off_stopped_ball_action_1:any;
  def_stopped_ball_action_1:any;
  off_stopped_ball_action_2:any;
  def_stopped_ball_action_2:any;
  ...
  ngOnInit() {
    ...
    this.api.getMyPlayers(this.user.id).subscribe((data:any)=>{
      ...
      this.players_1 = this.players.filter((x:any)=>x.team_id == this.proyect.team1.id);
      this.players_2 = this.players.filter((x:any)=>x.team_id == this.proyect.team2.id);
