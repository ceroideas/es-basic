...
export class PlayersPage implements OnInit {
  ...
  report_date:any;
  // report_skills:any;
  // report_technical:any;
  report_psychological:any;
  report_tec_ind_off:any;
  report_tec_ind_def:any;
  report_tac_asp_off:any;
  report_tac_asp_def:any;
  report_condition:any;
  report_speed:any;
  report_conclusion:any;
  ...
  savePlayer()
  {
    ...
    this.loadingCtrl.create().then(a=>{
      ...
      this.api.upPlayer(
        ...
        let i = this.players.findIndex((x:any)=>x.id == this.player.id);
        this.players[i] = data;
        //**//
      },err=>{
        a.dismiss();
